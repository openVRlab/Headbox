...
namespace ViveSR
{
    namespace anipal
    {
        namespace Lip
        {
            ...
            #region HeadBox_LipMapping_Variables
            [Serializable]
            public class LipMapping
            {
                public LipShape_v2 viveName;
                public string avatarName;
                public float headboxWeight = 1.0f;
            }

            [Serializable]
            public class HeadboxMapped
            {
                public int headboxMappedIndex;
                public string headboxMappedName;
                public float headboxWeight = 1.0f;

                public HeadboxMapped(int newheadboxMappedIndex, string newheadboxMappedName, float newheadboxWeight)
                {
                    headboxMappedIndex = newheadboxMappedIndex;
                    headboxMappedName = newheadboxMappedName;
                    headboxWeight = newheadboxWeight;
                }
